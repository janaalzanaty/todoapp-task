    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                <form action="../projectt3/handelers/update-task.php?id=<?php echo $_GET['id']; ?>" method="POST" class="form border p-2 my-5">
                    ...
                    <?php endif; ?>
                    <input type="text" name="title" value="" class="form-control my-3 border border-success" placeholder="add new todo">
